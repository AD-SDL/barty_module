...
class Motor:
    ...
    motorpins = {
        "MOTOR4": {
            "config": {1: {"e": 32, "f": 24, "r": 26}, 2: {"e": 32, "f": 26, "r": 24}},
            "arrow": 1,
        },
        "MOTOR3": {
            "config": {1: {"e": 19, "f": 21, "r": 23}, 2: {"e": 19, "f": 23, "r": 21}},
            "arrow": 2,
        },
        "MOTOR2": {
            "config": {1: {"e": 22, "f": 16, "r": 18}, 2: {"e": 22, "f": 18, "r": 16}},
            "arrow": 3,
        },
        "MOTOR1": {
            "config": {1: {"e": 11, "f": 15, "r": 13}, 2: {"e": 11, "f": 13, "r": 15}},
            "arrow": 4,
        },
    }
...
class Stepper:
    ...
    stepperpins = {
        "STEPPER1": {"en1": 11, "en2": 22, "c1": 13, "c2": 15, "c3": 18, "c4": 16},
...
class Sensor:
    ...
    sensorpins = {
        "IR1": {"echo": 7, "check": iRCheck},
        "IR2": {"echo": 12, "check": iRCheck},
